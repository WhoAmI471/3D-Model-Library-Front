...
**Затронутые файлы:**
- `src/lib/errorHandler.js` ✅ (новый файл - функции форматирования ошибок)
- `src/lib/errorMessages.js` ✅ (новый файл - централизованные сообщения)
- `src/components/ErrorBoundary.jsx` ✅ (новый компонент - React Error Boundary)
- `src/components/ErrorBoundaryWrapper.jsx` ✅ (новый компонент - обертка для layout)
- `src/app/layout.js` ✅ (добавлен ErrorBoundary)
- `src/lib/apiClient.js` ✅ (интеграция обработки ошибок - используется errorMessages)
