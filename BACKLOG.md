...
**Задачи:**
- [ ] Создать `src/lib/apiClient.js` с базовым классом/функциями
- [ ] Реализовать автоматическую обработку ошибок
- [ ] Реализовать автоматическое добавление токенов авторизации
- [ ] Реализовать перехватчики (interceptors) для запросов/ответов
- [ ] Создать специализированные методы для каждого ресурса:
  - [ ] `apiClient.models.get()`, `apiClient.models.create()`, и т.д.
  - [ ] `apiClient.projects.get()`, `apiClient.projects.create()`, и т.д.
  - [ ] `apiClient.employees.get()`, `apiClient.employees.create()`, и т.д.
  - [ ] `apiClient.spheres.get()`, `apiClient.spheres.create()`, и т.д.
  - [ ] `apiClient.auth.login()`, `apiClient.auth.me()`, и т.д.
- [ ] Рефакторинг всех компонентов для использования нового API клиента
- [ ] Удалить неиспользуемые импорты `axios`
